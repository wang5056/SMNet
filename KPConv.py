...
class KPConvRegressor(nn.Module):
    ...
    def forward(self, tdata):
        ...
        pooled_output = geo_nn.global_mean_pool(kpconv_output.x, kpconv_output.batch) # mean pooling
...
csv_name = 'predictions_thermal_KPConv_testdata.csv'
model_save_path = "KPConv_regression_thermal.pth"
df_featureTrain = pd.read_csv('/workspace/inputthermal_train_new.csv', header=None)
df_featureTest = pd.read_csv('/workspace/inputthermal_test_new.csv', header=None)
df_xTrain = pd.read_csv('/workspace/x_thermaltrain.csv', header=None)
df_yTrain = pd.read_csv('/workspace/y_thermaltrain.csv', header=None)
df_zTrain = pd.read_csv('/workspace/z_thermaltrain.csv', header=None)
df_xTest = pd.read_csv('/workspace/x_thermaltest.csv', header=None)
df_yTest = pd.read_csv('/workspace/y_thermaltest.csv', header=None)
df_zTest = pd.read_csv('/workspace/z_thermaltest.csv', header=None)
...
model = KPConvRegressor(input_nc, 1024, output_dim)
mse_loss = MSELoss()
mae_loss = L1Loss()
